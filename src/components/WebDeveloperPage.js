      ...
      <section id="about" className="about-section" aria-labelledby="about-heading">
        <div className="about-row">
          ...
          <div className="about-text-content fade-in-right">
            <h2 id="about-heading" className="about-title"> <span className="bg-primary-blue"> About</span> Us</h2>

            <div className="about-feature slide-up">
              <FaLaptopCode className="feature-icon" />
              <p>
                We are <strong>Web Development</strong> specialist in React, Node.js, and MERN Stack, building modern, scalable apps.
              </p>
            </div>
            ...
            <div className="about-feature slide-up delay-1">
              ...
              <p>
                As an <strong>App Developer</strong>, We create responsive and intuitive web apps with smooth UI/UX and real-time features.
              </p>
            </div>
            ...
            <div className="about-feature slide-up delay-2">
              ...
              <p>
                We build complete <strong>E-commerce Solutions</strong> with Razorpay integration, product carts, and admin dashboards.
              </p>
            </div>
          </div>
        </div>
